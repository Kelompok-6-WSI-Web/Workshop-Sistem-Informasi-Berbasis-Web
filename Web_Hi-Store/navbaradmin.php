  ...
  <body id="page-top">
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainnav">
        ...
        <ul class="navbar-nav mx-auto">
            ...
            <a class="nav-link js-scroll-trigger text-white ml-4" href="home_admin.php">HOME<span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
            <a class="nav-link js-scroll-trigger text-white ml-4" href="admin/produk.php">EDIT SHOP</a>
            </li>
            <li class="nav-item">
