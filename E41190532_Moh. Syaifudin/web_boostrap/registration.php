          ...
          <div class="row">
           ...
           <div class="col-xl-12 col-lg-7">
               <div class="card shadow mb-4">
                    ...
                    <div class ="card-header py-3 d-flex dlex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">Registration</h6>
                        <div class="droopdown no-arrow">
                    ...
                    <div class="card-body">
                        <form action="">
                            ...
                            <div class="form-group">
                            <textarea name="textbox" id="textbox" name="textbox" class="form-control form-control-user"></textarea>
                            </div>
                           ...
                           r $name = @$_GET['name'];
                            ...
                            if($textbox){
                              echo "<strong>Pengalaman:</strong> {$textbox}<br>";
                            }
                            ?>
                        </form>
                    </div>
